...
class Game():
    ...
    def game_run(self):
        ...
        while self.running:
            ...
            #print(self.my_camera.off_set_x, self.player_character.pos_x_returning_room, self.my_camera.off_set_y, self.player_character.pos_y_returning_room)
            ...
            if self.player_character.is_returning_room(self.myRoom.current_room()):
                ...
                self.my_camera = camera.Camera(self.myRoom.current_room(), self.player_character, self.screen)
                self.my_camera.off_set_map(self.player_character.pos_x_returning_room, self.player_character.pos_y_returning_room + 380)
